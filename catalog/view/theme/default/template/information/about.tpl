...
<div class="container">
    ...
    <div class="rows">
        ...
        <div class="col-lg-12 col-md-12 hidden-sm hidden-xs row">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 no-padding" >
            ...
            <div class="row" style="padding-bottom: 3%;">
                <div class="col-lg-1 col-md-1 col-sm-1"></div>
                    <div class="col-lg-3 col-md-4 col-sm-5 col-xs-9"style="padding: 0;">
                        <h1>О КОМПАНИИ</h1>
                    </div>
                    <div class="col-lg-8 col-md-7 col-sm-6 col-xs-3" style="padding: 0;">
                        <div class="col-lg-8 col-md-8 col-sm-8 hidden-xs" style="min-height: 38px;border-bottom: 2px solid #999999;"></div>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="min-height: 38px;border-bottom: 2px solid #f8c828;"></div>
                    </div>
        ...
        <div class="row" style="padding-bottom: 3%;">
            ...
            <div class="col-lg-8 col-md-8 col-sm-7 col-xs-3" style="padding: 0;">
                <div class="col-lg-5 col-md-5 col-sm-5 hidden-xs" style="min-height: 38px;border-bottom: 2px solid #999999;"></div>
                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12" style="min-height: 38px;border-bottom: 2px solid #f8c828;"></div>
            </div>
        </div>
    </div>
<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="padding: 0;">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border">
            ...
            <p class="hidden-lg hidden-md col-sm-12 col-xs-12  text-zal" style="margin-left: 5%;">
    ...
    <div class="col-lg-12 col-md-12 hidden-sm hidden-xs text-end">
        <div class="row" style="padding-bottom: 3%;">
            ...
            <div class="col-lg-6 col-md-5 col-sm-4 col-xs-4" style="padding: 0;">
                <div class="col-lg-3 col-md-3 col-sm-4 hidden-xs" style="min-height: 129px;border-bottom: 2px solid #999999;"></div>
                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12" style="min-height: 129px;border-bottom: 2px solid #f8c828;"></div>
            </div>
        </div>
        <p>
