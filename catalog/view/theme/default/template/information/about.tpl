...
<div class="container">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="padding: 0;">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border" style="background-image: url(/../catalog/view/theme/default/image/2.png);">
            ...
            <p class="hidden-xs hidden-sm text-zal" style="margin-left: 5%;">В работе с клиентами мы используем комплексный подход, который помогает экон
            ...
            <p class="hidden-lg hidden-md hidden-sm-12 hidden-xs-12  text-zal" style="margin-left: 5%;">
                В работе с клиентами мы используем комплексный
                0подход, который помогает время и силы
                наших заказчиков.
            </p>
        </div>
    </div>
