<ul id="menu">
  ...
  <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
    <ul>
      ...
      <li><a class="parent">новости/наши работы</a>
        <ul>
          <li><a href="<?php echo $newsblogcategory; ?>">добавление новых категорий</a></li>
          <li><a href="<?php echo $newsblogarticle; ?>">добавление новых статей</a></li>
        </ul>
      </li>
